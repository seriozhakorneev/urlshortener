...
var file_shortener_proto_rawDesc = []byte{
	...
	,
}
...
var file_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_shortener_proto_goTypes = []interface{}{
	(*Message)(nil), // 0: shortener.Message
}
var file_shortener_proto_depIdxs = []int32{
	0, // 0: shortener.UrlService.Create:input_type -> shortener.Message
	0, // 1: shortener.UrlService.Get:input_type -> shortener.Message
	0, // 2: shortener.UrlService.Create:output_type -> shortener.Message
	0, // 3: shortener.UrlService.Get:output_type -> shortener.Message
...
func (c *urlServiceClient) Create(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/shortener.UrlService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *urlServiceClient) Get(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/shortener.UrlService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedUrlServiceServer) Create(context.Context, *Message) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (*UnimplementedUrlServiceServer) Get(context.Context, *Message) (*Message, error) {
...
func _UrlService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shortener.UrlService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UrlServiceServer).Create(ctx, req.(*Message))
	}
...
func _UrlService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shortener.UrlService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UrlServiceServer).Get(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
